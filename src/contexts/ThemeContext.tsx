...
export type ThemeState = 'lightMode' | 'darkMode';
...
export const AppThemeProvider = ({ children }: PropsWithChildren<unknown>): any => {
  const [currentTheme, setCurrentTheme] = useState<ThemeState>(() => {
    ...
    return storedTheme ? JSON.parse(storedTheme) : 'lightMode';
  });
